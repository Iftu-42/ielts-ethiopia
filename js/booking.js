...
const bookingPackages = {
  ...
  evaluation: { service: "mock", name: "IELTS Evaluation Package", price: "600 ETB" },
  report: { service: "mock", name: "IELTS Report Package", price: "700 ETB" },
  premium: { service: "mock", name: "IELTS Premium Coaching Package", price: "800 ETB" },
  listening: { service: "skill", name: "Listening Package", price: "250 ETB" },
  reading: { service: "skill", name: "Reading Package", price: "250 ETB" },
